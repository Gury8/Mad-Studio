...
type
  ...
  TfrmPmg = class(TForm)
    ...
    procedure PopUpProc(Sender : TObject; Button : TMouseButton; Shift : TShiftState;
      X, Y : Integer);
    ...
    procedure Player0Proc(Sender : TObject);
    procedure Player1Proc(Sender : TObject);
    procedure Player2Proc(Sender : TObject);
    procedure Player3Proc(Sender : TObject);
  ...
  private
    ...
    procedure OpenPlayerFile(filename : string);
  public
    { public declarations }
    filename : string;
...
uses
  main, pmg_gen, colors, pm_apl, lib, viewer;
...
procedure TfrmPmg.ViewerProc(Sender : TObject);
begin
  frmViewer.isModal := true;
  frmViewer.ShowModal;
  if frmViewer.filename <> '' then
    OpenPlayerFile(frmViewer.filename);
end;
...
procedure TfrmPmg.PopUpProc(Sender : TObject; Button : TMouseButton; Shift : TShiftState;
  X, Y : Integer);
begin
...
procedure TfrmPmg.ApplyPlayerHeightProc(Sender : TObject);
begin
  _PM_MAX_LINES := editPlayerHeight.Value;
  PmgSettings;
end;

procedure TfrmPmg.ApplyMissileHeightProc(Sender : TObject);
begin
...
// A=44, B=114 - min x
// A=204 - max x
  FillRectEx(imgPlayerLocation, colTab[0], 0, 0, imgPlayerLocation.Width, imgPlayerLocation.Height);
  FillRectEx(imgPlayerLocation, colTab[3], 6, 18, imgPlayerLocation.Width - 12, imgPlayerLocation.Height - 36);
  FillRectEx(imgPlayerLocation, colTab[player + 4], tbHorizontal.Position - 44, tbVertical.Position, 8, 10);
end;
...
procedure TfrmPmg.Player0Proc(Sender : TObject);
begin
  rbPlayer0.Checked := true;
  rbPlayerChange(Sender);
end;

procedure TfrmPmg.Player1Proc(Sender : TObject);
begin
  rbPlayer1.Checked := true;
  rbPlayerChange(Sender);
end;

procedure TfrmPmg.Player2Proc(Sender : TObject);
begin
  rbPlayer2.Checked := true;
  rbPlayerChange(Sender);
end;

procedure TfrmPmg.Player3Proc(Sender : TObject);
begin
...
procedure TfrmPmg.LoadPlayerData;  //(fs : TFileStream);
var
  x, y, h, col : byte;
  bin : string;
begin
...
{-----------------------------------------------------------------------------
 Load data from file
 -----------------------------------------------------------------------------}
procedure TfrmPmg.OpenPlayerFile(filename : string);
begin
...
begin
  FillRectEx(imgP0, colTab[4], 0, 0, imgP0.width, imgP0.Height);
  FillRectEx(imgP1, colTab[5], 0, 0, imgP1.width, imgP1.Height);
  FillRectEx(imgP2, colTab[6], 0, 0, imgP2.width, imgP2.Height);
  FillRectEx(imgP3, colTab[7], 0, 0, imgP3.width, imgP3.Height);
...
begin
  ...
  editor.Canvas.Brush.Color := coltab[0];
  ...
  FillRectEx(imgP0_normal02, coltab[0], 0, 0, imgP0_normal02.Width, imgP0_normal02.Height);
  FillRectEx(imgP1_normal02, coltab[0], 0, 0, imgP0_normal02.Width, imgP0_normal02.Height);
  FillRectEx(imgP2_normal02, coltab[0], 0, 0, imgP0_normal02.Width, imgP0_normal02.Height);
  FillRectEx(imgP3_normal02, coltab[0], 0, 0, imgP0_normal02.Width, imgP0_normal02.Height);

  FillRectEx(imgP0_single, coltab[0], 0, 0, imgP0_single.Width, imgP0_single.Height);
  FillRectEx(imgP1_single, coltab[0], 0, 0, imgP0_single.Width, imgP0_single.Height);
  FillRectEx(imgP2_single, coltab[0], 0, 0, imgP0_single.Width, imgP0_single.Height);
  FillRectEx(imgP3_single, coltab[0], 0, 0, imgP0_single.Width, imgP0_single.Height);

  FillRectEx(imgP0_normal, coltab[0], 0, 0, imgP0_normal.Width, imgP0_normal.Height);
  FillRectEx(imgP0_double, coltab[0], 0, 0, imgP0_double.Width, imgP0_double.Height);
  FillRectEx(imgP0_quadrable, coltab[0], 0, 0, imgP0_quadrable.Width, imgP0_quadrable.Height);

  FillRectEx(imgP0_normalSr, coltab[0], 0, 0, imgP0_normalSr.Width, imgP0_normalSr.Height);
  FillRectEx(imgP0_doubleSr, coltab[0], 0, 0, imgP0_doubleSr.Width, imgP0_doubleSr.Height);
  FillRectEx(imgP0_quadrableSr, coltab[0], 0, 0, imgP0_quadrableSr.Width, imgP0_quadrableSr.Height);
...
begin
  imgMissile00.Canvas.Brush.Color := coltab[0];
...
//    bounds(0, 0, imgMissileSingle0.Width, imgMissileSingle0.Height));
  ...
  imgMissileSingle1.Canvas.Brush.Color := coltab[0];
...
//    bounds(0, 0, imgM0_normal_sr.Width, imgM0_normal_sr.Height));
  ...
  imgM0_double_sr.Canvas.Brush.Color := coltab[0];
  ...
  for yf := 0 to _PM_MAX_LINES - 1 do begin
    for xf := 0 to _PM_WIDTH + _MAX_PLAYER_POS do begin
      ...
      if col = 1 then begin
        ...
        editorMulti.Canvas.Brush.Color := coltab[0];
        if col01 = 1 then
          editorMulti.Canvas.Brush.Color := coltab[5];
...
procedure TfrmPmg.NumProc(Sender: TObject);
var
  dataValue, i, j : byte;
  bin : string;
begin
...
procedure TfrmPmg.PaletteProc(Sender: TObject);
begin
  frmColors.Show;
end;
