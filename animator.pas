...
uses
  ...
  Menus, ExtCtrls, ComCtrls, StdCtrls, lcltype, Buttons, Spin, Types, LCLIntf,
  common;
...
type
  ...
  TfrmAnimator = class(TForm)
    ...
    procedure btnByteEditorClick(Sender : TObject);
    ...
    procedure imgFrameMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
      X, Y: Integer);
//    procedure imgP0xMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState;
//      X, Y: Integer);
...
procedure TfrmAnimator.btnByteEditorClick(Sender : TObject);
var
  i, j : byte;
  k : integer;
  bin : string;
...
begin
  ...
  for j := 1 to 16 do begin
    if j < 10 then begin
      (FindComponent('imgFrame0' + IntToStr(j)) as TImage).Canvas.Brush.Color := clBlack;
      (FindComponent('imgFrame0' + IntToStr(j)) as TImage).Canvas.FillRect(bounds(
        0, 0, imgFrame01.Width, imgFrame01.Height));
    end
    else begin
      (FindComponent('imgFrame' + IntToStr(j)) as TImage).Canvas.Brush.Color := clBlack;
      (FindComponent('imgFrame' + IntToStr(j)) as TImage).Canvas.FillRect(bounds(
        0, 0, imgFrame01.Width, imgFrame01.Height));
    end;
  end;
  imgBuffer.Canvas.Brush.Color := clBlack;
...
begin
  ...
  for j := 1 to 16 do begin
    ...
    (FindComponent('imgFrame' + compIndex) as TImage).Canvas.Brush.Color := clBlack;
    (FindComponent('imgFrame' + compIndex) as TImage).Height := imgFrame01.Height;
    (FindComponent('imgFrame' + compIndex) as TImage).Canvas.FillRect(bounds(
      0, 0, imgFrame01.Width, imgFrame01.Height));
//    end
  ...
  //imgFrame01.Canvas.Brush.Color := clBlack;
  //imgFrame01.Canvas.FillRect(bounds(0, 0, imgFrame01.Width, imgFrame01.Height));
  //imgFrame02.Canvas.Brush.Color := clBlack;
  ...
  //imgFrame04.Canvas.Brush.Color := clBlack;
  //imgFrame04.Canvas.FillRect(bounds(0, 0, imgFrame04.Width, imgFrame01.Height));
  //imgFrame05.Canvas.Brush.Color := clBlack;
  //imgFrame05.Canvas.FillRect(bounds(0, 0, imgFrame05.Width, imgFrame01.Height));
  //imgFrame06.Canvas.Brush.Color := clBlack;
  //imgFrame06.Canvas.FillRect(bounds(0, 0, imgFrame06.Width, imgFrame01.Height));
  //imgFrame07.Canvas.Brush.Color := clBlack;
  //imgFrame07.Canvas.FillRect(bounds(0, 0, imgFrame07.Width, imgFrame01.Height));
  //imgFrame08.Canvas.Brush.Color := clBlack;
  //imgFrame08.Canvas.FillRect(bounds(0, 0, imgFrame08.Width, imgFrame01.Height));
  //imgFrame09.Canvas.Brush.Color := clBlack;
  //imgFrame09.Canvas.FillRect(bounds(0, 0, imgFrame09.Width, imgFrame01.Height));
  //imgFrame10.Canvas.Brush.Color := clBlack;
  //imgFrame10.Canvas.FillRect(bounds(0, 0, imgFrame10.Width, imgFrame01.Height));
  //imgFrame11.Canvas.Brush.Color := clBlack;
  //imgFrame11.Canvas.FillRect(bounds(0, 0, imgFrame11.Width, imgFrame01.Height));
  //imgFrame12.Canvas.Brush.Color := clBlack;
  //imgFrame12.Canvas.FillRect(bounds(0, 0, imgFrame12.Width, imgFrame01.Height));
  //imgFrame13.Canvas.Brush.Color := clBlack;
  //imgFrame13.Canvas.FillRect(bounds(0, 0, imgFrame13.Width, imgFrame01.Height));
  //imgFrame14.Canvas.Brush.Color := clBlack;
  //imgFrame14.Canvas.FillRect(bounds(0, 0, imgFrame14.Width, imgFrame01.Height));
  //imgFrame15.Canvas.Brush.Color := clBlack;
  //imgFrame15.Canvas.FillRect(bounds(0, 0, imgFrame15.Width, imgFrame01.Height));
  //imgFrame16.Canvas.Brush.Color := clBlack;
  //imgFrame16.Canvas.FillRect(bounds(0, 0, imgFrame16.Width, imgFrame01.Height));
  imgBuffer.Canvas.Brush.Color := clBlack;
  imgBuffer.Canvas.FillRect(bounds(0, 0, imgBuffer.Width, imgBuffer.Height));
...
//  if not CalcPlayerWidth(player, xf, yf) then Exit;
  ...
  case frame of
    ...
    3: begin
         imgFrame04.Canvas.Brush.Color := coltab[col + 4];
         imgFrame04.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    4: begin
         imgFrame05.Canvas.Brush.Color := coltab[col + 4];
         imgFrame05.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    5: begin
         imgFrame06.Canvas.Brush.Color := coltab[col + 4];
         imgFrame06.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    6: begin
         imgFrame07.Canvas.Brush.Color := coltab[col + 4];
         imgFrame07.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    7: begin
         imgFrame08.Canvas.Brush.Color := coltab[col + 4];
         imgFrame08.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    8: begin
         imgFrame09.Canvas.Brush.Color := coltab[col + 4];
         imgFrame09.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    9: begin
         imgFrame10.Canvas.Brush.Color := coltab[col + 4];
         imgFrame10.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    10: begin
         imgFrame11.Canvas.Brush.Color := coltab[col + 4];
         imgFrame11.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    11: begin
         imgFrame12.Canvas.Brush.Color := coltab[col + 4];
         imgFrame12.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    12: begin
         imgFrame13.Canvas.Brush.Color := coltab[col + 4];
         imgFrame13.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    13: begin
         imgFrame14.Canvas.Brush.Color := coltab[col + 4];
         imgFrame14.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    14: begin
         imgFrame15.Canvas.Brush.Color := coltab[col + 4];
         imgFrame15.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    15: begin
         imgFrame16.Canvas.Brush.Color := coltab[col + 4];
         imgFrame16.Canvas.FillRect(bounds(xf*factX02, yf*factY02, factX02, factY02));
       end;
    16: begin
...
//procedure TfrmAnimator.RefresPM(pm : TImage; factX, factY : byte; isMultiColor : boolean);
//var
//  col, xf, yf : byte;
//  index, ci : byte;
//  maxX : byte;
...
//  index := player;
//
//  if isMultiColor then begin
//    maxX := grX*4 + 3;
//    for yf := 0 to _ANIM_MAX_LINES - 1 do begin
//      n := 0;
//      for xf := playerIndex[frame, index] to maxX do begin
//        col := playerPos[frame, index, xf, yf];
//        pm.Canvas.Brush.Color := coltab[ci + 4];
//
//        if n < 8 then begin
//          fld[frame][index, n, yf] := col;
////        fld[index, xf - playerIndex[index], yf] := col;
//        end;
//
//        Inc(n);
//
...
//          pm.Canvas.Brush.Color := clBlack;
//
//        pm.Canvas.FillRect(bounds(
//          (xf - playerIndex[frame, index])*factX, yf*factY, factX, factY));
//      end;
//    end;
//  end
//  else begin
...
//end;
//
//procedure TfrmAnimator.MenuItem32Click(Sender: TObject);
//begin
//  isValueDec := false;
//  RefreshValues;
//end;
...
procedure TfrmAnimator.ToggleBox1Change(Sender : TObject);
begin
...
procedure TfrmAnimator.ToggleBox2Change(Sender : TObject);
begin
...
procedure TfrmAnimator.ToggleBox3Change(Sender : TObject);
begin
...
procedure TfrmAnimator.ToggleBox4Change(Sender : TObject);
begin
...
procedure TfrmAnimator.ToggleBox5Change(Sender : TObject);
begin
...
procedure TfrmAnimator.ToggleBox6Change(Sender : TObject);
begin
