...
type
  ...
  TfrmCopyPlayers = class(TForm)
    ...
    procedure btnCloseWinClick(Sender : TObject);
    procedure btnCopyToFrame0Click(Sender : TObject);
    procedure btnCopyToFrames0Click(Sender : TObject);
...
begin
  imgPlayer0dr.Canvas.Brush.Color := clBlack;
  imgPlayer0sr.Canvas.Brush.Color := clBlack;
  imgPlayer1dr.Canvas.Brush.Color := clBlack;
  imgPlayer1sr.Canvas.Brush.Color := clBlack;
  imgPlayer2dr.Canvas.Brush.Color := clBlack;
  imgPlayer2sr.Canvas.Brush.Color := clBlack;
  imgPlayer3dr.Canvas.Brush.Color := clBlack;
  imgPlayer3sr.Canvas.Brush.Color := clBlack;
end;

procedure TfrmCopyPlayers.Button2Click(Sender : TObject);
begin
...
procedure TfrmCopyPlayers.btnCloseWinClick(Sender : TObject);
begin
  Close;
end;

procedure TfrmCopyPlayers.btnCopyToFrame0Click(Sender : TObject);
var
  d, h, m : byte;
  f0, f1 : byte;
begin
...
procedure TfrmCopyPlayers.btnCopyToFrames0Click(Sender : TObject);
var
  d, h, m, k : byte;
  f0, f1 : byte;
begin
