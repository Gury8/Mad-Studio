...
type
  ...
  TfrmAnimLoadSave = class(TForm)
    ...
    procedure FramesItemClick(Sender: TObject; Index: integer);
...
procedure TfrmAnimLoadSave.LoadClick(Sender: TObject);
var
  filenamex : string;
  fs : TFileStream;
  d, h, m, k : byte;
...
//        showmessage(inttostr(colorMem[d div 2]));
...
procedure TfrmAnimLoadSave.FramesItemClick(Sender: TObject; Index: integer);
begin
//  for i := 0 to 16 do begin
...
procedure TfrmAnimLoadSave.CloseClick(Sender: TObject);
begin
  Close;
end;
