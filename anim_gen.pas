...
uses
  ...
  Dialogs, StdCtrls, lcltype, ExtCtrls, Spin, Windows,
  common;
...
type
  ...
  TfrmAnimGen = class(TForm)
    ...
    procedure ListExamplesClick(Sender: TObject);
...
//    code.line := '';
  ...
  { Mad Pascal
   ---------------------------------------------------------------------------}
  else if radLang.ItemIndex = 2 then begin
    codex := 'const'#13#10 +
  ...
  { Action!
   ---------------------------------------------------------------------------}
  else if radLang.ItemIndex = 3 then begin
...
//              codex += '    ';
  ...
  { FastBasic
   ---------------------------------------------------------------------------}
  else if radLang.ItemIndex = 4 then begin
    codex := ''' Colors for players'#13#10;
    for pl := 0 to 1 do begin
...
//    Inc(lineNum, 10);
    code.line += CodeLine('DATA ' + IntToStr(frmAnimator.numFrames.Value));
    code.line += CodeLine('REM *** HEIGHT ***');
    code.line += CodeLine('DATA ' + IntToStr(animFrameHeight));
    code.line += CodeLine('REM *** GAP ***');
    code.line += CodeLine('DATA 0');
    code.line += GenData;
  end
  { Mad Pascal
   ---------------------------------------------------------------------------}
...
//            '  height = ' + IntToStr(animFrameHeight) + ';'#13#10 +
  ...
  { Mad Assembler (MADS)
   ---------------------------------------------------------------------------}
  else if radLang.ItemIndex = 5 then begin
  ...
  { CC65
   ---------------------------------------------------------------------------}
  else if radLang.ItemIndex = 6 then begin
...
procedure TfrmAnimGen.ListExamplesClick(Sender: TObject);
var
  i : byte;
begin
